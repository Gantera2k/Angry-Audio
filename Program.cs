...
namespace AngryAudio
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Set system timer resolution to 1ms so our 10ms animation/poll timers are smooth
            // (Windows default is 15.6ms which causes visible shimmer choppiness)
            timeBeginPeriod(1);
        ...
        private static void OnThreadException(object sender, ThreadExceptionEventArgs e)
        {
            ...
            try { Audio.SetMicMute(false); } catch { } // Force unmute on crash
