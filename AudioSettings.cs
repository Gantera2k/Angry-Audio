...
namespace AngryAudio
{
    ...
    {
        None,
        PttKey1, PttKey2, PttKey3,
        PtmKey1, PtmKey2, PtmKey3,
        ToggleKey1, ToggleKey2, ToggleKey3
    }
    ...
    public enum SettingsChange
    {
        ...
        VoiceActivity = 1 << 10, // Voice activity mode changed
    }
    ...
    public class AudioSettings
    {
        ...
        public int PttKey3
        {
            get { return _s.PushToTalkKey3; }
            set { if (_s.PushToTalkKey3 != value) { _s.PushToTalkKey3 = value; _s.Save(); Fire(SettingsChange.PttMode); } }
        }
        public bool PttShowOverlay
        {
        ...
        public bool PttKey3ShowOverlay
        {
            get { return _s.PttKey3ShowOverlay; }
            set { if (_s.PttKey3ShowOverlay != value) { _s.PttKey3ShowOverlay = value; _s.Save(); Fire(SettingsChange.PttCosmetic); } }
        }
        ...
        public int PtmKey3
        {
            get { return _s.PushToMuteKey3; }
            set { if (_s.PushToMuteKey3 != value) { _s.PushToMuteKey3 = value; _s.Save(); Fire(SettingsChange.PttMode); } }
        }
        ...
        public int PtToggleKey3
        {
            get { return _s.PushToToggleKey3; }
            set { if (_s.PushToToggleKey3 != value) { _s.PushToToggleKey3 = value; _s.Save(); Fire(SettingsChange.PttMode); } }
        }
        ...
        public void DisablePttMode()
        {
            ...
            _s.PushToTalkKey = 0; _s.PushToTalkKey2 = 0; _s.PushToTalkKey3 = 0;
            _s.Save();
            _suppressEvents = false;
            Fire(SettingsChange.PttMode);
        }
        ...
        public void DisablePtmMode()
        {
            ...
            _s.PushToMuteKey = 0; _s.PushToMuteKey2 = 0; _s.PushToMuteKey3 = 0;
            _s.Save();
            _suppressEvents = false;
            Fire(SettingsChange.PttMode);
        }
        ...
        public void DisablePtToggleMode()
        {
            ...
            _s.PushToToggleKey = 0; _s.PushToToggleKey2 = 0; _s.PushToToggleKey3 = 0;
            _s.Save();
            _suppressEvents = false;
            Fire(SettingsChange.PttMode);
        }
        ...
        public bool VoiceActivityShowOverlay
        {
            ...
            set { if (_s.VoiceActivityShowOverlay != value) { _s.VoiceActivityShowOverlay = value; _s.Save(); Fire(SettingsChange.VoiceActivity); } }
        }
        ...
        public void StartCapture(CaptureTarget target, Action<int> callback)
        {
            ...
            {
                _captureTimer = new System.Windows.Forms.Timer { Interval = 30 };
        ...
        private void CaptureTimerTick(object s, EventArgs e)
        {
            if (!_capturing) { _captureTimer.Stop(); return; }
            ...
            for (int vk = 1; vk < 256; vk++)
            {
                ...
                if (down && !wasDown)
                {
                    ...
                    if (vk == 0x10) vk = (GetAsyncKeyState(0xA1) & 0x8000) != 0 ? 0xA1 : 0xA0;
                    if (vk == 0x11) vk = (GetAsyncKeyState(0xA3) & 0x8000) != 0 ? 0xA3 : 0xA2;
                    if (vk == 0x12) vk = (GetAsyncKeyState(0xA5) & 0x8000) != 0 ? 0xA5 : 0xA4;

                    // Escape = cancel
                    if (vk == 0x1B) vk = 0;

                    Logger.Info("AudioSettings: captured vk=0x" + vk.ToString("X2") + " (" + PushToTalk.GetKeyName(vk) + ")");

                    if (_captureCallback != null) { try { _captureCallback(vk); } catch { } }
                    _captureCallback = null;
                    return;
                }
            }
        ...
        /// <summary>Check if a key is already used by another mode.</summary>
        public bool IsKeyInUse(int vk, int excludeMode)
        {
            if (vk <= 0) return false;
            // excludeMode: 0=PTT, 1=PTM, 2=Toggle
            if (excludeMode != 0 && (vk == PttKey || vk == PttKey2 || vk == PttKey3)) return true;
            if (excludeMode != 1 && (vk == PtmKey || vk == PtmKey2 || vk == PtmKey3)) return true;
            if (excludeMode != 2 && (vk == PtToggleKey || vk == PtToggleKey2 || vk == PtToggleKey3)) return true;
            return false;
        }
        ...
        public bool IsDuplicateInMode(int vk, CaptureTarget target)
        {
            ...
            switch (target)
            {
                case CaptureTarget.PttKey1: return vk == PttKey2 || vk == PttKey3;
                case CaptureTarget.PttKey2: return vk == PttKey || vk == PttKey3;
                case CaptureTarget.PttKey3: return vk == PttKey || vk == PttKey2;
                case CaptureTarget.PtmKey1: return vk == PtmKey2 || vk == PtmKey3;
                case CaptureTarget.PtmKey2: return vk == PtmKey || vk == PtmKey3;
                case CaptureTarget.PtmKey3: return vk == PtmKey || vk == PtmKey2;
                case CaptureTarget.ToggleKey1: return vk == PtToggleKey2 || vk == PtToggleKey3;
                case CaptureTarget.ToggleKey2: return vk == PtToggleKey || vk == PtToggleKey3;
                case CaptureTarget.ToggleKey3: return vk == PtToggleKey || vk == PtToggleKey2;
            }
            return false;
        }

        /// <summary>Get the exclude mode index (0=PTT,1=PTM,2=Toggle) for a capture target.</summary>
        public static int ExcludeModeFor(CaptureTarget t)
        {
            if (t >= CaptureTarget.PttKey1 && t <= CaptureTarget.PttKey3) return 0;
            if (t >= CaptureTarget.PtmKey1 && t <= CaptureTarget.PtmKey3) return 1;
            return 2;
        }
