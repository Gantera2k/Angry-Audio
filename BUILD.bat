...
C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe /target:winexe /out:"Angry Audio.exe" ^
  ...
  AppVersion.cs Audio.cs CorrectionToast.cs DarkTheme.cs Dpi.cs FadeOverlay.cs InstanceDialog.cs Logger.cs Mascot.cs MicStatusOverlay.cs ^
  OptionsForm.cs Program.cs PushToTalk.cs Settings.cs ToastStack.cs TrayApp.cs WelcomeForm.cs
...
C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe /target:winexe /out:"Angry_Audio_Setup.exe" ^
  ...
  Installer.cs Mascot.cs AppVersion.cs DarkTheme.cs Dpi.cs Logger.cs
